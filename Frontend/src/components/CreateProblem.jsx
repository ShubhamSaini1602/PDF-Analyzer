...
function CreateProblem(){
    ...
    return (
        ...
        <div className="create-div">
            <img src="/create-problem-icon.png" className="create-problem-icon2"></img>
            <p className="create-header-text">Create Problem</p>
        </div>
        <p className="create-header-description">Add a new coding challenge to help developers improve their skills.</p>

        <div className="form-all-details">
                    <h2 className="problem-details">Problem Details</h2>
                    <p className="extra-form-text">Fill in all the required information for the new problem.</p>
                    <form onSubmit={handleSubmit(onSubmit)} className="main-form">
                        ...
                        <div className="form-element2">
                            ...
                            <select className="form-select" {...register("difficulty")}>
                                <option value="Select Difficulty" selected disabled>Select Difficulty</option>
                        ...
                        <div className="form-element2">
                            ...
                            {startCodeFields.map((field, index) => (
                                <div key={field.id} className="array-item-fixed">
                                    ...
                                    <textarea
                                        placeholder={`Initial Code Template for Users in ${field.language}`}
                        ...
                        <div className="form-element2">
                            ...
                            {solutionFields.map((field, index) => (
                                <div key={field.id} className="array-item-fixed">
                                    ...
                                    <textarea
                                        placeholder="Provide the reference solution here..."
                                        className="form-textarea code"
                                        rows="15"
